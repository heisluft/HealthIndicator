...
public class HealthIndicator extends JavaPlugin {
	...
	//		e.printStackTrace();
		...
		System.out.println(cprefix + "HealthIndicator by Nathan_N version " + this.getDescription().getVersion() + " enabled.");
	}
	...
	public void onDisable() {
		...
		System.out.println(cprefix + "HealthIndicator by Nathan_N version " + this.getDescription().getVersion() + " disabled.");
	}
	...
	public void sendInfo(CommandSender sender) {
		...
		sender.sendMessage(ChatColor.BLUE + "HealthIndicator plugin version " + this.getDescription().getVersion() + " by Nathan_N" + ChatColor.RESET);
		...
		sender.sendMessage(ChatColor.BLUE + "Source code: https://github.com/NathanNr/HealthIndicator/" + ChatColor.RESET);
